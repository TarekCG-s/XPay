"""
Django settings for xpay_project project.
...
SECRET_KEY = '%a#c3d(ij*ak+7p)g!-9fp##z)1vad*2luvoj@xz2w@tzm$v2t'
...
ROOT_URLCONF = 'xpay_project.urls'
...
WSGI_APPLICATION = 'xpay_project.wsgi.application'
